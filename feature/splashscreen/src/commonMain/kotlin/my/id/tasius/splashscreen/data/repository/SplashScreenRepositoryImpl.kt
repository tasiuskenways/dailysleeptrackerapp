...
import my.id.tasius.common.Constant
...
class SplashScreenRepositoryImpl(
     ...
     *
     * This function checks the DataStore for a specific key ([Constant.IS_FIRST_RUN_LOCAL_KEY]).
    ...
    override suspend fun getIsFirstRun(): Boolean {
        val isFirstRun = dataStoreHelper.getBoolean(Constant.IS_FIRST_RUN_LOCAL_KEY) ?: true
        return isFirstRun
    }
